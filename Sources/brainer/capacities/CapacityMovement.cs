...
{
  abstract public class CapacityMovement : BrainerLogicCapacity, scaffolder.iScaffDebug
  {
    ...
    virtual public string stringify()
    {
      ...
      ct += "\n └ " + HalperString.iStringFormatBool("moved", _moved);
      ct += "\n └ movement last frame : " + lastFullMovement.x + " x " + lastFullMovement.y;
      ct += "\n └ position : " + transform.position;

      ct += "\n" + HalperString.iStringFormatBool("lock horizontal", lockHorizontal.isLocked());
