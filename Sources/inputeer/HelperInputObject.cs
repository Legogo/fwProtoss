...
namespace inputeer
{
    public class HelperInputObject
    {
        ...
        public iInputeerCandidate owner;
        ...
        public virtual void setInteractive(bool flag)
        {
            ...
            if (!_interactive) owner.getMono().gameObject.layer = 0;
            else
            {
                //reinjecte la layer input si besoin
                if (_inputLayerAtStart) owner.getMono().gameObject.layer = LayerMask.NameToLayer("input");
            }
