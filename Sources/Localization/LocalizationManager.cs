...
#if UNITY_EDITOR
  [MenuItem("Localization/ppref/de")] public static void pprefDE() => editor_switchLanguage(IsoLanguages.de, false);
  [MenuItem("Localization/ppref/en")] public static void pprefEN() => editor_switchLanguage(IsoLanguages.en, false);
  [MenuItem("Localization/ppref/es")] public static void pprefES() => editor_switchLanguage(IsoLanguages.es, false);
  [MenuItem("Localization/ppref/fr")] public static void pprefFR() => editor_switchLanguage(IsoLanguages.fr, false);
  [MenuItem("Localization/ppref/it")] public static void pprefIT() => editor_switchLanguage(IsoLanguages.it, false);
  [MenuItem("Localization/ppref/po")] public static void pprefPO() => editor_switchLanguage(IsoLanguages.po, false);
  [MenuItem("Localization/ppref/ru")] public static void pprefRU() => editor_switchLanguage(IsoLanguages.ru, false);
  [MenuItem("Localization/ppref/cn")] public static void pprefZH() => editor_switchLanguage(IsoLanguages.zh, false);

  [MenuItem("Localization/swap/deu")] public static void swapDE() => editor_switchLanguage(IsoLanguages.de);
  [MenuItem("Localization/swap/eng")] public static void swapEN() => editor_switchLanguage(IsoLanguages.en);
  [MenuItem("Localization/swap/esp")] public static void swapES() => editor_switchLanguage(IsoLanguages.es);
  [MenuItem("Localization/swap/fre")] public static void swapFR() => editor_switchLanguage(IsoLanguages.fr);
  [MenuItem("Localization/swap/ita")] public static void swapIT() => editor_switchLanguage(IsoLanguages.it);
  [MenuItem("Localization/swap/por")] public static void swapPO() => editor_switchLanguage(IsoLanguages.po);
  [MenuItem("Localization/swap/rus")] public static void swapRU() => editor_switchLanguage(IsoLanguages.ru);
  [MenuItem("Localization/swap/chi")] public static void swapZH() => editor_switchLanguage(IsoLanguages.zh);
